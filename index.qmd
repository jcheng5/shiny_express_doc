...
If you've seen Shiny applications written in the existing syntax (which we'll now refer to as "Shiny Core"), you'll notice some important differences. Here's the same app written in Shiny Core form:
